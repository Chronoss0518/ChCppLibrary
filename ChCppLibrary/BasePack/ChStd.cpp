...
#define CH_DECIMAL_NUMBUR_FUNCTION(type) CH_NUMBER_FUNCTION(DECIMAL_NUMBUR,type)
#endif

#ifndef CH_HEXA_DECIMAL_FUNCTION
#define CH_HEXA_DECIMAL_FUNCTION(type) CH_NUMBER_FUNCTION(HEXA_DECIMAL,type)
#endif

#ifndef CH_OCTAL_FUNCTION
#define CH_OCTAL_FUNCTION(type) CH_NUMBER_FUNCTION(OCTAL,type)
#endif

#ifndef CH_BINARY_FUNCTION
#define CH_BINARY_FUNCTION(type) CH_NUMBER_FUNCTION(BINARY_NUMBER,type)
#endif

#ifndef CH_BASE_64_FUNCTION
#define CH_BASE_64_FUNCTION(type) CH_NUMBER_FUNCTION(BASE_NUMBER_64,type)
#endif

#ifndef CH_ZERO_CHARA_FUNCTION
#define CH_ZERO_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetZeroChara,type)
#endif

#ifndef CH_0_CHARA_FUNCTION
#define CH_0_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(Get0Chara,type)
#endif

#ifndef CH_HYPHEN_CHARA_FUNCTION
#define CH_HYPHEN_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetHyphenChara,type)
#endif

#ifndef CH_CRLF_CHARA_FUNCTION
#define CH_CRLF_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetCRLFChara,type)
#endif

#ifndef CH_CR_CHARA_FUNCTION
#define CH_CR_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetCRChara,type)
#endif

#ifndef CH_LF_CHARA_FUNCTION
#define CH_LF_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetLFChara,type)
#endif

#ifndef CH_BACK_CHARA_FUNCTION
#define CH_BACK_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetBackChara,type)
#endif

#ifndef CH_NEXT_PAGE_CHARA_FUNCTION
#define CH_NEXT_PAGE_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetNextPageChara,type)
#endif

#ifndef CH_TAB_CHARA_FUNCTION
#define CH_TAB_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetTabChara,type)
#endif

#ifndef CH_COMMA_CHARA_FUNCTION
#define CH_COMMA_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetCommaChara,type)
#endif

#ifndef CH_DOT_CHARA_FUNCTION
#define CH_DOT_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetDotChara,type)
#endif

#ifndef CH_SEMICOLON_CHARA_FUNCTION
#define CH_SEMICOLON_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetSemiColonChara,type)
#endif

#ifndef CH_DOUBLECOLON_CHARA_FUNCTION
#define CH_DOUBLECOLON_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetDoubleColonChara,type)
#endif

#ifndef CH_SPACE_CHARA_FUNCTION
#define CH_SPACE_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetSpaceChara,type)
#endif

#ifndef CH_SLASH_CHARA_FUNCTION
#define CH_SLASH_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetSlashChara,type)
#endif

#ifndef CH_YEN_CHARA_FUNCTION
#define CH_YEN_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetYenChara,type)
#endif

#ifndef CH_START_PARENTHESES_CHARA_FUNCTION
#define CH_START_PARENTHESES_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetStartParenthesesChara,type)
#endif

#ifndef CH_END_PARENTHESES_CHARA_FUNCTION
#define CH_END_PARENTHESES_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetEndParenthesesChara,type)
#endif

#ifndef CH_START_BRACE_CHARA_FUNCTION
#define CH_START_BRACE_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetStartBraceChara,type)
#endif

#ifndef CH_END_BRACE_CHARA_FUNCTION
#define CH_END_BRACE_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetEndBraceChara,type)
#endif

#ifndef CH_START_BRACKET_CHARA_FUNCTION
#define CH_START_BRACKET_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetStartBracketChara,type)
#endif

#ifndef CH_END_BRACKET_CHARA_FUNCTION
#define CH_END_BRACKET_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetEndBracketChara,type)
#endif

#ifndef CH_SINGLE_QUOTATION_CHARA_FUNCTION
#define CH_SINGLE_QUOTATION_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetSGQuotation,type)
#endif

#ifndef CH_DOUBLE_QUOTATION_CHARA_FUNCTION
#define CH_DOUBLE_QUOTATION_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetDBQuotation,type)
#endif

#ifndef CH_ASTERISK_CHARA_FUNCTION
#define CH_ASTERISK_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(GetAsterisk,type)
#endif
