...
{
	vertexs[0].uv = ChVec2(_rect.left, _rect.top);
	vertexs[1].uv = ChVec2(_rect.right, _rect.top);
	vertexs[2].uv = ChVec2(_rect.right, _rect.bottom);
	vertexs[3].uv = ChVec2(_rect.left, _rect.bottom);
}
